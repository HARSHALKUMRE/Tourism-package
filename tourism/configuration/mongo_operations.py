...
class MongoDBOperation:
    def __init__(self):
        ...
        self.client = MongoClient(self.mongo_config.MONGO_DB_URL)
    ...
    def get_collection(database: Database, collection_name: str) -> Collection:
        ...
        try:
            collecion = database[collection_name]
    ...
    def get_collection_as_dataframe(self, database_name: str, collection_name: str) -> DataFrame:
    ...
    def insert_dataframe_as_record(self, data_frame: DataFrame, database_name: str, collection_name: str) -> None:
